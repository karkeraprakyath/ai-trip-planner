"use client";
import { Calendar, User2, Users, Wallet } from "lucide-react";
import {
  useMotionValueEvent,
  useScroll,
  useTransform,
    ...
    >
      <div className="max-w-7xl mx-auto py-7 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
          Your Trip Itinerarry from <strong className="text-primary">{tripData?.origin} to {tripData?.destination}</strong> is ready
        </h2>
